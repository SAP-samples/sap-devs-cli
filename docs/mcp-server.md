...
| `recommend_tutorials` | Get profile-matched tutorial recommendations plus any in-progress tutorials | `limit` (optional, default 5, max 20) |
...
| -------- | ------- | ----- | ------ |
| **sap-devs** | `sap-devs mcp serve` | 31 | SAP knowledge, CF/BTP inspection, learning, news, tutorial guided execution |

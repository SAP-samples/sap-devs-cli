    ...
    - main: .
      ...
      ignore:
        - goos: windows
          goarch: arm64
      ldflags:
        - -X github.tools.sap/developer-relations/sap-devs-cli/cmd.Version={{ .Version }}
...
- [ ] **Step 4: Manual smoke test of the full binary**
  ...
  ```bash
  go build -ldflags "-X github.tools.sap/developer-relations/sap-devs-cli/cmd.Version=0.0.1" -o sap-devs-test .
